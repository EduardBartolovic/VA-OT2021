...
\begin{document}
	...
	.....
	In der dritten Version wurde vorallem die Genauigkeit weiter verbessert. So wurden Restblöcke, Skip-Verbindungen und Upsampling Techinken hinzugefügt die Yolov2 auf einen modernen Stand gebracht haben. ALLE 3 ERKLÄREN. Das Netzwerk wuchs auch drastisch auf 106 Convolutional-Layer. Darknet-53.. MEHR NETZWERK. SCALES... LOSSFUNCTION??...
	Eine weitere Änderung betrifft den Softmax layer für die Bestimmung der Zielklasse. Früher wurde immer nur die Klasse ausgewählt die den höchsten Wert erhielt. Dies hat sich geändert. Dadurch das die Klassenvorhersage mit Hilfe einer Logistische Regession stattfindet kein ein Objekt mehre Label gleichzeitig haben. Diese Multilabelklassifikation wird für unser Projekt aber nicht benötigt.
