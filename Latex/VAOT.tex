...
\begin{document}
	...
	\begin{enumerate}
		...
		\item \textbf{Nachvollziehbarkeit:} Bei Fehlern in der Objekterkennung bei Yolo ist es häufig schwierig nachzuvollziehen wie diese entstanden. Bei MOG ist dies deutlich einfacher da man nur das Graubild untersuchen muss.
	\end{enumerate}
