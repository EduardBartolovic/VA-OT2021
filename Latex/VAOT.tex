...
\begin{document}
	...
	\author{\IEEEauthorblockN{1\textsuperscript{st} Bartolovic Eduard}
		...
		\and
		\IEEEauthorblockN{2\textsuperscript{rd} Schäfer Julia}
		\IEEEauthorblockA{\textit{Hochschule München} \\
			München, Deutschland \\
			j.schaefer0@hm.edu}
		\and
		\IEEEauthorblockN{3\textsuperscript{nd} Willeit Thomas}
		\IEEEauthorblockA{\textit{Hochschule München} \\
			München, Deutschland \\
